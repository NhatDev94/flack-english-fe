      ...
      _proto.fixLayoutHeight = function fixLayoutHeight(extra) {
        ...
        if (offset !== false) {
          if (max == heights.control_sidebar) {
            $(Selector.CONTENT).css('height', max + offset);
          } else if (max == heights.window) {
            $(Selector.CONTENT).css('height', max + offset - heights.header - heights.footer);
          } else {
            $(Selector.CONTENT).css('height', max + offset - heights.header);
          }
        }
